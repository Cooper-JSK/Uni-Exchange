...
const ViewQuestion = ({ filterCategory, setFilterCategory }) => {
    ...
    const fetchQuestionData = async () => {
        try {
            const data = await fetchQuestionAndAnswers(id); // Use the service function
        ...
        <div className="flex justify-center p-4">
            <div className="flex flex-col md:flex-row w-full max-w-7xl">
                <div className="w-full md:w-1/5 hidden md:block">
                    <SidebarLeft setFilterCategory={setFilterCategory} /> {/* Pass setFilterCategory */}
                </div>
                <div className="w-full md:w-3/5 mx-0 md:mx-4">
                    <div className="p-5 my-3 border rounded shadow-md bg-white">
                        ...
                        <div className="mb-4">
                            <div className="text-gray-700"><RenderJSON content={question.content}/></div>
                        </div>
